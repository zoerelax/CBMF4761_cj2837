...
### prevalence = 49.2/1000

```{r}
# set prevalence
prevalence <- 49.2/1000  # male ASD prevalence
...
save(h2_summary, file = "~/Documents/Yufeng_Lab/BHR/final/sex_male/sex_male_summary.RData")
```
...
ggplot(h2_summary, aes(x = h2, y = bin, fill = grp)) +
  ...
  labs(
    ...
    title = "Partitioned h² (effect size² * frequency) for Males w/ ASD"
  ) +
  theme_minimal()
```
